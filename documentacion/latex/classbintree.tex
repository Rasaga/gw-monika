...
\begin{DoxyCompactList}\small\item\em Reemplaza el receptor por una copia de subarbol. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Obtener el nodo raiz. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Podar el subarbol a la izquierda de un nodo. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Podar el subarbol a la derecha de un nodo. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Insertar un arbol como subarbol a la izquierda de un nodo. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Insertar un arbol como subarbol a la derecha de un nodo. \end{DoxyCompactList}\item 
void \hyperlink{classbintree_a2078f7f9254a84b592fdb1f2e2f9238a}{clear} ()
\begin{DoxyCompactList}\small\item\em Hace nulo un arbol. \end{DoxyCompactList}\item 
size\+\_\+type \hyperlink{classbintree_a05abb18037587082a67fb4d4d2f5733f}{size} () const 
\begin{DoxyCompactList}\small\item\em Obtiene el namero de nodos. \end{DoxyCompactList}\item 
bool \hyperlink{classbintree_a772126c3e8b7cd37e5a93ccbda01f8dd}{empty} () const 
\begin{DoxyCompactList}\small\item\em Comprueba si un arbol esta vacao (es nulo). \end{DoxyCompactList}\item 
bool \hyperlink{classbintree_a29438cd817b1d27ccc10d46676ba6bef}{operator==} (const \hyperlink{classbintree}{bintree}$<$ T $>$ \&a) const 
\begin{DoxyCompactList}\small\item\em Operador de comparacian de igualdad. \end{DoxyCompactList}\item 
bool \hyperlink{classbintree_a80e397f887ebad1ef974ec7722430a6c}{operator!=} (const \hyperlink{classbintree}{bintree}$<$ T $>$ \&a) const 
\begin{DoxyCompactList}\small\item\em Operador de comparacian de desigualdad. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Reemplaza el subarbol a partir de pos por una copia de subarbol. \end{DoxyCompactList}\item 
...
Son mutables. Residen en memoria dinamica.
...
Crea un arbol nulo. \index{bintree@{bintree}!bintree@{bintree}}
\index{bintree@{bintree}!bintree@{bintree}}
...
{\em e} & Etiqueta para la raiz.\\
\hline
\end{DoxyParams}
Crea un arbol con un unico nodo etiquetado con e. \index{bintree@{bintree}!bintree@{bintree}}
\index{bintree@{bintree}!bintree@{bintree}}
...
\begin{DoxyParams}{Parámetros}
{\em a} & arbol que se copia.\\
\hline
\end{DoxyParams}
Crea un arbol duplicado exacto de a. \index{bintree@{bintree}!````~bintree@{$\sim$bintree}}
...
Reemplaza el receptor por una copia de subarbol. 


\begin{DoxyParams}{Parámetros}
{\em a} & Arbol desde el que se copia. \\
\hline
{\em n} & nodo raiz del subarbol que se copia.\\
\hline
\end{DoxyParams}
El receptor se hace nulo y despues se le asigna una copia del subarbol de a cuya raiz es n. \index{bintree@{bintree}!clear@{clear}}
...
Destruye todos los nodos del arbol receptor y lo hace un arbol nulo. \index{bintree@{bintree}!empty@{empty}}
...
Comprueba si un arbol esta vacao (es nulo). 

\begin{DoxyReturn}{Devuelve}
true, si el receptor esta vacao (es nulo). false, en otro caso. 
\end{DoxyReturn}
...
\hline
\end{DoxyParams}
Desconecta y destruye el subarbol a la izquierda de n, inserta un nuevo nodo con etiqueta e como hijo a la izquierda \index{bintree@{bintree}!insert\+\_\+left@{insert\+\_\+left}}
\index{insert\+\_\+left@{insert\+\_\+left}!bintree@{bintree}}
...
Insertar un arbol como subarbol a la izquierda de un nodo. 


\begin{DoxyParams}{Parámetros}
{\em n} & nodo del receptor. n != nodo\+\_\+nulo. \\
\hline
{\em rama} & subarbol que se inserta. Es M\+O\+D\+I\+F\+I\+C\+A\+DO.\\
\hline
\end{DoxyParams}
Desconecta y destruye el subarbol a la izquierda de n, le asigna el valor de rama como nuevo subarbol a la izquierda y rama se hace arbol nulo. \index{bintree@{bintree}!insert\+\_\+right@{insert\+\_\+right}}
...
\hline
\end{DoxyParams}
Desconecta y destruye el subarbol a la derecha de n, inserta un nuevo nodo con etiqueta e como hijo a la derecha \index{bintree@{bintree}!insert\+\_\+right@{insert\+\_\+right}}
\index{insert\+\_\+right@{insert\+\_\+right}!bintree@{bintree}}
...
Insertar un arbol como subarbol a la derecha de un nodo. 
...
\hline
\end{DoxyParams}
Desconecta y destruye el subarbol a la izquierda de n, le asigna el valor de rama como nuevo subarbol a la derecha y rama se hace arbol nulo. \index{bintree@{bintree}!operator"!=@{operator"!=}}
...
Operador de comparacian de desigualdad. 


\begin{DoxyParams}{Parámetros}
{\em a} & arbol con que se compara el receptor.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
...
Operador de comparacian de igualdad. 
...
Podar el subarbol a la izquierda de un nodo. 


\begin{DoxyParams}{Parámetros}
{\em n} & nodo del receptor. !n.null(). \\
\hline
{\em dest} & subarbol a la izquierda de n. Es M\+O\+D\+I\+F\+I\+C\+A\+DO.\\
\hline
\end{DoxyParams}
Desconecta el subarbol a la izquierda de n, que pasa a ser un arbol nulo. El subarbol anterior se devuelve sobre dest. \index{bintree@{bintree}!prune\+\_\+right@{prune\+\_\+right}}
...
Podar el subarbol a la derecha de un nodo. 


\begin{DoxyParams}{Parámetros}
{\em n} & nodo del receptor. !n.null(). \\
\hline
{\em dest} & subarbol a la derecha de n. Es M\+O\+D\+I\+F\+I\+C\+A\+DO.\\
\hline
\end{DoxyParams}
Desconecta el subarbol a la derecha de n, que pasa a ser un arbol nulo. El subarbol anterior se devuelve sobre dest. \index{bintree@{bintree}!replace\+\_\+subtree@{replace\+\_\+subtree}}
...
Reemplaza el subarbol a partir de pos por una copia de subarbol. 


\begin{DoxyParams}{Parámetros}
{\em pos} & nodo a partir del que se colagara la copia \\
\hline
{\em a} & Arbol desde el que se copia. \\
\hline
{\em n} & nodo raaz del subarbol que se copia.\\
\hline
\end{DoxyParams}
El receptor se modifica colocando a partir de pos una copia del subarbol de a cuya raaz es n. \index{bintree@{bintree}!root@{root}}
...
Obtiene el namero de nodos. 

\begin{DoxyReturn}{Devuelve}
namero de nodos del receptor. 
\end{DoxyReturn}
