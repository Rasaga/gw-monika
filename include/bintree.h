...
/**
   ...
   Representa un arbol binario con nodos etiquetados con datos del tipo T.
...
public:
  ...
  */
  ...
  /**
     ...
     @param e Etiqueta para la raiz.

     Crea un arbol con un unico nodo etiquetado con e.
  */
  bintree(const T & e);
  ...
  /**
     ...
     Crea un arbol duplicado exacto de a.
  */
  bintree (const bintree<T> & a);

  /**
     @brief Reemplaza el receptor por una copia de subarbol.

     @param a Arbol desde el que se copia.
     @param n nodo raiz del subarbol que se copia.

     El receptor se hace nulo y despues se le asigna una copia
     del subarbol de a cuya raiz es n.
  */
  ...
  */
  ...
  /**
     @brief Obtener el nodo raiz.

     @return nodo raiz del receptor.
  */
  node root() const;

  /**
     @brief Podar el subarbol a la izquierda de un nodo.

     @param n: nodo del receptor. !n.null().
     @param dest: subarbol a la izquierda de n. Es MODIFICADO.

     Desconecta el subarbol a la izquierda de n, que pasa a
     ser un arbol nulo. El subarbol anterior se devuelve sobre
     dest.
  */
  void prune_left(node n, bintree<T> & dest);

  /**
     @brief Podar el subarbol a la derecha de un nodo.

     @param n: nodo del receptor. !n.null().
     @param dest: subarbol a la derecha de n. Es MODIFICADO.

     Desconecta el subarbol a la derecha de n, que pasa a
     ser un arbol nulo. El subarbol anterior se devuelve sobre
     dest.
  */
  ...
  /**
     ...
     Desconecta y destruye el subarbol a la izquierda de n, inserta
     un nuevo nodo con etiqueta e como hijo a la izquierda
  */
  void insert_left(const bintree<T>::node & n, const T & e);

  /**
     @brief Insertar un arbol como subarbol a la izquierda de un nodo.

     @param n: nodo del receptor. n != nodo_nulo.
     @param rama: subarbol que se inserta. Es MODIFICADO.

     Desconecta y destruye el subarbol a la izquierda de n, le
     asigna el valor de rama como nuevo subarbol a la izquierda
     y rama se hace arbol nulo.
  */
  ...
  /**
     ...
     Desconecta y destruye el subarbol a la derecha de n, inserta
     un nuevo nodo con etiqueta e como hijo a la derecha
  */
  void insert_right(node n, const T & e);

  /**
     @brief Insertar un arbol como subarbol a la derecha de un nodo.

     @param n: nodo del receptor. !n.Nulo().
     @param rama: subarbol que se inserta. Es MODIFICADO.

     Desconecta y destruye el subarbol a la izquierda de n, le
     asigna el valor de rama como nuevo subarbol a la derecha
     y rama se hace arbol nulo.
  */
  void insert_right(node n, bintree<T> & rama);

  /**
     @brief Hace nulo un arbol.

     Destruye todos los nodos del arbol receptor y lo hace
     un arbol nulo.
  */
  void clear();

  /**
     @brief Obtiene el namero de nodos.

     @return namero de nodos del receptor.
  */
  size_type size() const;

  /**
     @brief Comprueba si un arbol esta vacao (es nulo).

     @return true, si el receptor esta vacao (es nulo).
             false, en otro caso.
  */
  bool empty() const;
  ...
  /**
     @brief Operador de comparacian de igualdad.

     @param a: arbol con que se compara el receptor.
  ...
  */
  ...
  /**
     @brief Operador de comparacian de desigualdad.
  ...
  */
  ...
  /**
     @brief Reemplaza el subarbol a partir de pos por una copia de subarbol.

     @param pos nodo a partir del que se colagara la copia
     @param a Arbol desde el que se copia.
     @param n nodo raaz del subarbol que se copia.

     El receptor se modifica colocando a partir de pos una copia
     del subarbol de a cuya raaz es n.
  */
  void replace_subtree(node pos, const bintree<T> &a, node n);

  /**
     Clase iterator para recorrer el arbol en PreOrden
  */
  ...
  /**
     Clase iterator para recorrer el arbol en Inorden
  */
...
class const_inorder_iterator
 {
  ...
  /**
     Clase iterator para recorrer el arbol en PostOrden
  */
...
class const_postorder_iterator
 {
  ...
  /**
     Clase iterator para recorrer el arbol por niveles
  */
...
private:
  ...
  /**
     @brief Destruir subarbol.

     @param n: nodo raaz del subarbol que se destruye.
     @doc:
     Destruye el subarbol cuya raaz es n.
  */
  void destroy(bintree<T>::node n);


  /**
     @brief Copia subarbol.

     @param dest: nodo sobre el que se copia. dest.null().
            Es MODIFICADO.
     @param orig: raaz del subarbol que se copia.

     @doc
     Destruye el subarbol con raaz en dest. Sobre aste realiza
     un duplicado del subarbol con raaz en orig.
  */
  void copy(node & dest, const node &orig);


  /**
     @brief Cuenta el namero de nodos.

     @param n: raaz del subarbol a contar.

     @return devuelve el namero de nodos del subarbol que
             tiene n como raaz.

     Cuenta el namero de nodos en el subarbol cuuya raaz es n.
  */
  int count(node n) const;

  /**
     @brief Comparacian de igualdad.

     @param n1: raiz del primer subarbol.
     @param n2: raiz del segundo subarbol.

     @return true, si los dos subarboles son iguales, en
  ...
  */
  ...
  /**
      TDA nodo.
      Modela los nodos del arbol binario.
  */
